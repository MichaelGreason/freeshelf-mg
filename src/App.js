  ...
  return (
    <>
      ...
      <div className='short-image'>
        ...
        <div className='image'>{<img src={book.coverImageUrl}> ? <img src={book.coverImageUrl} alt="cover" width="125" height="175"/> : ''}</div>
      </div>
      ...
      <div><p><strong>URL: </strong><a href={book.url}>{book.url}</a></p>
        <p >{book.publisher ? `Publisher: ${book.publisher}` : ''}</p>
